  ...
  return (
    ...
    <div className="footer text-white justify-between gap-16 bg-gray-900 px-5 lg:px-28  ">
      ...
      <div className="footer-1 items-center align-middle justify-center gap-30 flex">
        <div className="pages gap-16 font-medium align-middle">
          <div className="pages-1 flex gap-16">
            <p>Home</p>
            <p>About Me</p>
            <p>Services</p>
          </div>

          <div className="pages-2 mt-7 flex gap-16">
            <p>Resume</p>
            <p>Portfolio</p>
            <p>Blog</p>
          </div>
    ...
    <div className="flex justify-between bg-black w-full px-28">
            <div>
          <p className="textt-center text-gray-700 mt-2" > Copyright @2025 AZM, All Rights Reserved.</p>
          </div>
          <div className="flex gap-16">
          <div>
          <p className="text-center text-gray-700 bg-black mt-2" > Privacy Policy</p>
          </div>
          <div>
          <p className="text-center text-gray-700 bg-black mt-2" > Terms of Use</p>
          </div>
          </div>
          </div>
    </div>
